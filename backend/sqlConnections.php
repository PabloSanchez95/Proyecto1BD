...
function executeQueryMaster($query){
	set_time_limit(0);
	$_SESSION['error_sql'] = "";
	$_SESSION['sql_debug'] = $query;
	$link = mysql_connect("10.48.54.105", "masteraccess","masteraccess123") or die (json_encode(array('success'=>'false','error_sql'=>mysql_error(),'messageText'=>'Error de conexi&oacute;n')));
...
function executeQueryRead($query){
	set_time_limit(0);
	$_SESSION['error_sql'] = "";
	$_SESSION['sql_debug'] = $query;
